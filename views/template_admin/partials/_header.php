		...
		<div class="topbar">
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
					<form>
						<?php $this->load->view('template_admin/partials/_extras/dropdown/notifications', $dataNotification) ?>
			...
			<div class="dropdown">
				...
				<div class="
						...
						p-0
					">
					<?php $this->load->view('template_admin/partials/_extras/dropdown/user') ?>
				</div>
