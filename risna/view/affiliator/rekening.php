                    ...
                    <div class="card-body ">
                        ...
                        <div class="pt-6 pb-8">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <!-- <span class="text-muted"><?= $bank['nama_bank']; ?></span> -->
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">Nama Pemilik:</span>
                                <!-- <span class="text-muted"><?= $rekening['nama_pemilik_rek']; ?></span> -->
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">No. Rekening:</span>
                                <!-- <span class="text-muted"><?= $rekening['no_rek']; ?></span> -->
                            </div>
                        </div>
                        <!--end::Contact-->
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
							...
							<div class="navi-item mb-2">
                                <a href="<?= base_url('affiliator/Rekening') ?>" class="navi-link py-4 active">
                                    <span class="navi-icon mr-2">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card card-custom  card-stretch gutter-b">
                            ...
                            <div class="card" style="width: 40rem;">
                                ...
                                <!--begin::Form-->
                                <form action="<?= base_url('affiliator/rekening'); ?>" method="post" class="form offcanvas-mobile w-350px w-xxl-750px">
                                    <div class="card-body offcanvas-mobile w-40px w-xxl-700px">
                                        <!--begin::Heading-->
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label class="col-xl-6 col-lg-3 col-form-label" for="nama_bank">Nama Bank</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="input-group input-group-lg input-group-solid">
													<select id="id_bank" name="id_bank" class="form-control form-control-lg form-control-solid">
                                        ...
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label class="col-xl-6 col-lg-3 col-form-label" for="nama_pemiliki_rek">Nama Pemilik Rekening</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" id="nama_pemiliki_rek" name="nama_pemiliki_rek"/>
                                            </div>
                                            <?= form_error('nama_pemiliki_rek', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label id="city_id" name="city_id" class="col-xl-6 col-lg-3 col-form-label" for="no_rek">Nomer Rekening</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" id="no_rek" name="no_rek" />
                                            </div>
