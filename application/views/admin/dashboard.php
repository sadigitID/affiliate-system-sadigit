  ...
  <div class="col-xl-4">
    ...
    <div class="card card-custom bg-light-success card-stretch gutter-b">
      ...
      <div class="card-body">
        ...
        <span class="card-title font-weight-bolder text-dark-75 font-size-h1 mb-0 mt-6 d-block"><?= $this->m_user->jumlah(); ?></span>
  ...
  <div class="col-xl-4">
    ...
    <div class="card card-custom bg-light-danger card-stretch gutter-b">
      ...
      <div class="card-body">
        ...
        <span class="card-title font-weight-bolder text-dark-75 font-size-h1 mb-0 mt-6 d-block"><?= $this->m_pesanan->jumlah_masuk(); ?></span>
  ...
  <div class="col-xl-4">
    ...
    <div class="card card-custom bg-light-info card-stretch gutter-b">
      ...
      <div class="card-body">
        ...
        <span class="card-title font-weight-bolder text-dark-75 font-size-h1 mb-0 mt-6 d-block"><?= $this->m_pesanan->jumlah_keluar(); ?></span>
...
<script>
  new Chart("myChart", {
    ...
    data: {
      ...
      datasets: [{
        data: <?= $this->m_pesanan->get_grafik(); ?>,
        backgroundColor: [
          "rgba(224, 77, 107, 0.5)",
          "rgba(255, 99, 132, 0.5)",
          "rgba(223, 132, 58, 0.5)",
