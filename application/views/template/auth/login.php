    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="login-aside d-flex flex-column flex-row-auto">
                ...
                <!--begin::Aside Bottom-->
                <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 5rem); background-image: url(<?= (''); ?>/assets/media/svg/illustrations/login-visual-5.svg)">
                </div>
                <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
                            ...
                            <div class="pb-lg-0 pb-5">
                                ...
                                <button type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon | path:<?= (''); ?>/assets/media/svg/social-icons/google.svg--><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
