		...
		<div class="topbar">
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
					<form>
						<?php $this->load->view('template/partials/_extras/dropdown/notifications', $dataNotification) ?>
				...
				<div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
					<div class="
						...
						<span class="
								...
								mr-3
							">
							<?= $this->session->set_userdata('nama_lengkap') ?></span>
						<span class="symbol symbol-35 symbol-light-success">
							<span class="symbol-label font-size-h5 font-weight-bold"><?= substr($this->session->set_userdata('nama_lengkap'), 0, 1) ?></span>
						</span>
					</div>
				</div>
