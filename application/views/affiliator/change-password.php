                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card card-custom  card-stretch gutter-b">
                            ...
                            <div class="card" style="width: 35rem;">
                                ...
                                <!--begin::Form-->
                                <form action="<?= base_url('affiliator/change_password/changePassword'); ?>" method="post" class="form offcanvas-mobile w-350px w-xxl-750px">
                                    <div class="card-body" style="width: 35rem;">
                                        <!--begin::Heading-->
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label class="col-xl-6 col-lg-12 col-form-label" for="password">Current Password</label>
                                            <div class="col-xl-12">
                                        ...
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label class="col-xl-6 col-lg-6 col-form-label" for="password1">New Password</label>
                                            <div class="col-xl-12">
                                                <input class="form-control form-control-lg form-control-solid" type="password" id="password1" name="password1"  />
                                            </div>
                                            <?= form_error('password1', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label id="city_id" name="city_id" class="col-xl-12 col-lg-6 col-form-label" for="password2">Confirm New Password</label>
                                            <div class="col-xl-12">
                                                <input class="form-control form-control-lg form-control-solid" type="password" id="password2" name="password2"  />
                                            </div>
