                    ...
                    <div class="card-body ">
                        ...
                        <div class="pt-6 pb-8">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="text-muted"><?= $rekening['nama_bank']; ?></span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <form action="<?= base_url('affiliator/rekening'); ?>" method="post" class="form offcanvas-mobile w-350px w-xxl-750px">
                                    <div class="card-body offcanvas-mobile w-40px w-xxl-700px">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-6 col-lg-3 col-form-label" for="id_bank">Nama Bank</label>
                                        ...
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label class="col-xl-6 col-lg-3 col-form-label" for="nama_pemilik_rek">Nama Pemilik Rekening</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" id="nama_pemilik_rek" name="nama_pemilik_rek"/>
                                            </div>
                                            <?= form_error('nama_pemilik_rek', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <!--begin::Form Group-->
                                        <div class="form-group row">
                                            <label id="no_rek" name="no_rek" class="col-xl-6 col-lg-3 col-form-label" for="no_rek">Nomer Rekening</label>
                                            <div class="col-lg-9 col-xl-9">
