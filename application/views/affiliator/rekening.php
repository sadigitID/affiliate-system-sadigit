			...
			<form id="form_rekening">
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-8">
							<!-- <input class="form-control " type="text" placeholder="Nama Bank" id="nama_bank" name="nama_bank" autocomplete="off" /> -->
					...
					<div class="form-group row">
						<label class="col-form-label col-4" for="no_rek ">Nomer Rekening</label>
						<div class="col-8">
							<input class="form-control " type="text" placeholder="Nomer Rekening" id="no_rek" name="no_rek" autocomplete="off" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-form-label col-4" for="nama_pemilik_rek ">Nama Pemilik</label>
						<div class="col-8">
							<input class="form-control " type="text" placeholder="Nama Pemilik" id="nama_pemilik_rek" name="nama_pemilik_rek" autocomplete="off" />
						</div>
					</div>
				</div>
			</form>
...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">Manajemen Alamat Rekening</h3>
		</div>
