...
class Reportpesanan_pdf extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['export'] = $export;
    $data['url_cetak'] = base_url('affiliator/' . $url_cetak);
    $data['label'] = $label;
  ...
  public function cetak()
  {
    ...
    $data['export'] = $export;
    ob_start();
    $this->load->view('affiliator/reportpesanan_pdf_print', $data);
    ...
    $pdf->WriteHTML($html);
    $pdf->Output('Data Pesanan Affiliate.pdf', 'D');
  }
}
